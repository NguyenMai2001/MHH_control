...
SOURCEFILES_QUOTED_IF_SPACED=I2C_LCD.c BTL_HIHI_main.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/I2C_LCD.p1 ${OBJECTDIR}/BTL_HIHI_main.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/I2C_LCD.p1.d ${OBJECTDIR}/BTL_HIHI_main.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/I2C_LCD.p1 ${OBJECTDIR}/BTL_HIHI_main.p1

# Source Files
SOURCEFILES=I2C_LCD.c BTL_HIHI_main.c
...
${OBJECTDIR}/BTL_HIHI_main.p1: BTL_HIHI_main.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/BTL_HIHI_main.p1.d 
	@${RM} ${OBJECTDIR}/BTL_HIHI_main.p1 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1    -fno-short-double -fno-short-float -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -DXPRJ_default=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file  -ginhx032 -Wl,--data-init -mno-keep-startup -mno-osccal -mno-resetbits -mno-save-resetbits -mno-download -mno-stackcall $(COMPARISON_BUILD)  -std=c99 -gdwarf-3 -mstack=compiled:auto:auto     -o ${OBJECTDIR}/BTL_HIHI_main.p1 BTL_HIHI_main.c 
	@-${MV} ${OBJECTDIR}/BTL_HIHI_main.d ${OBJECTDIR}/BTL_HIHI_main.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/BTL_HIHI_main.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
