...
figure(1)
    plot(t,q1,'r.',t,q2,'g.',t,q3,'b.',t,q4,'m.',t,q5,'c.')
    %ax1 = subplot(2,1,1);
...
for t_q3=0:0.08:1
    x_khau_3=cos(q1)*L3*cos(q3)*t_q3 + cos(q1)*L2;
    y_khau_3=sin(q1) * (L3 * cos(q3)*t_q3 + L2);
    z_khau_3=L3 * sin(q3)*t_q3 + q2;
    plot3(x_khau_3,y_khau_3,z_khau_3,'r.',cos(q1) * (L3 * cos(q3) + L2),sin(q1) * (L3 * cos(q3) + L2),L3 * sin(q3) + q2,'b.')
    hold on
    grid on
end

for t_q4=0:0.08:1
    x_khau_4=cos(q1) * (L3 * cos(q3) + cos(q3) * L4*t_q4 + L2);
    y_khau_4=sin(q1) * (L3 * cos(q3) + cos(q3) * L4*t_q4 + L2);
    z_khau_4=(sin(q3) * L4 *t_q4 + L3 * sin(q3) + q2);
    plot3(x_khau_4,y_khau_4,z_khau_4,'y.',cos(q1) * (L3 * cos(q3) + cos(q3) * L4 + L2) ,sin(q1) * (L3 * cos(q3) + cos(q3) * L4 + L2),sin(q3) * L4 + L3 * sin(q3) + q2 ,'g.')
    hold on
    grid on
end
for t_q5=0:0.08:1
    x_khau_5=(-L5 * cos(q5) * cos(q4) * sin(q3) * cos(q1) + L5 * cos(q5) * sin(q4) * sin(q1) - cos(q1) * cos(q3) * L5 * sin(q5))*t_q5 + cos(q1) * L3 * cos(q3) + cos(q1) * cos(q3) * L4 + cos(q1) * L2;
    y_khau_5=(-L5 * cos(q5) * cos(q4) * sin(q3) * sin(q1) - L5 * cos(q5) * sin(q4) * cos(q1) - sin(q1) * cos(q3) * L5 * sin(q5))*t_q5 + sin(q1) * L3 * cos(q3) + sin(q1) * cos(q3) * L4 + sin(q1) * L2;
    z_khau_5=(cos(q3) * cos(q4) * L5 * cos(q5) - sin(q3) * L5 * sin(q5))*t_q5 + sin(q3) * L4 + L3 * sin(q3) + q2;
